...
export const EVENTS: {
  ...
  },
  {
    ...
    img_url: '/library/4-instagram.jpeg',
  },
  {
    clubSlug: null,
...
export const SECTIONS: SectionSeed[] = [
  ...
  {
    type: 'events', title: 'Events', subtitle: 'here’s roughly what’s happening and roughly when. dates are optimistic.', accent: 'yellow',
    config: {},
  },
  {
